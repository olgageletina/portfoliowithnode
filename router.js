//parse the URL and designate a controller type
var url = require('url');  
var fs = require('fs');
...
exports.get = function(request, response) {  
  ...
  var extname = String(path.split('.').pop().toLowerCase());
...
function testPath (url, request, response){
	   ...
	   //current cateories
	   var categoryList = ['hardware', 'web-mobile', 'software', 'still-motion', 'materials']
